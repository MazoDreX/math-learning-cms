<div>
    ...
    <nav class="bg-white-800" x-data="{ isOpen: false }" >
  ...
  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div class="relative flex h-16 items-center justify-between">
      <div  class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        <!-- Mobile menu button-->
        <button @click="isOn = !isOn" type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-white-400 hover:bg-neutral-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
      ...
      <div  class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div  class="hidden sm:ml-6 sm:block">
          ...
          class="flex space-x-4">
            ...
            <a href="{{ route('index') }}" 
            :class="currentPage === 'index' ? 'bg-neutral-900 text-white' :  'text-neutral-900 hover:bg-neutral-700 hover:text-white'"
            :aria-current="currentPage === 'index' ? 'page' : false"
            class="rounded-md px-3 py-2 text-sm font-medium">Home</a>

            <a href="{{ route('about') }}" 
            :class="currentPage === 'about' ? 'bg-neutral-900 text-white' :  'text-neutral-900 hover:bg-neutral-700 hover:text-white'"
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="relative ml-3">
          <div>
            <button @click="isOpen = !isOpen" type="button" class="relative rounded-full bg-neutral-800 p-1 text-neutral-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-neutral-800">
  ...
  <div  class="sm:hidden" id="mobile-menu">
    ...
    class="space-y-1 px-2 pb-3 pt-2">
      ...
      <a href="{{ route('index') }}" 
        :class="currentPage === 'index' ? 'bg-white-900 text-white' :  'text-white-300 hover:bg-white-700 hover:text-white'"
        :aria-current="currentPage === 'index' ? 'page' : false"
        class="block rounded-md px-3 py-2 text-base font-medium">Home</a>
      <a href="{{ route('about') }}" 
        :class="currentPage === 'about' ? 'bg-white-900 text-white' :  'text-white-300 hover:bg-white-700 hover:text-white'"
        :aria-current="currentPage === 'about' ? 'page' : false"
