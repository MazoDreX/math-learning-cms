          ...
          -->
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div class="flex flex-shrink-0 items-center">
                <a href="{{ route('index') }}" class="font-semibold text-3xl dark:text-white">MathEdge</a>
              </div>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <div class="relative ml-3">
                <div>
                  <button @click="darkMode = !darkMode; localStorage.setItem('dark_mode', darkMode)" type="button" class="btn btn-secondary relative rounded-full  p-1 text-neutral-950 dark:text-neutral-400 dark:hover:text-neutral-300 hover:text-neutral-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-neutral-800" title="DarkMode">
