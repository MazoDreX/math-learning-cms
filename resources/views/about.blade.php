    ...
    <div class="my-7 px-8 max-w-screen-xl mx-auto">
      ...
      <div class="snap-x flex gap-6 snap-mandatory h-screen/2 w-96 p-4 mx-auto overflow-scroll md:w-3/4 lg:w-fit lg:overflow-hidden">
        <div class="snap-start p-8 bg-gradient-to-r shadow-md from-indigo-300 to-sky-300 dark:from-teal-500 dark:to-cyan-500 rounded-xl w-80 lg:w-72 flex-shrink-0 h-screen/2 flex flex-col items-center justify-center">
          <lottie-player src="https://lottie.host/d2809d88-ecc4-4bc2-884f-855dc1fe91d3/Bjadr7lTs3.json" background="##FFFFFF" speed="1" style="max-width: 300px; height: 200px" loop autoplay direction="1" mode="normal"></lottie-player>
        ...
        <div class="snap-start p-8 bg-gradient-to-r shadow-md from-sky-300 to-cyan-300 dark:from-sky-500 dark:to-blue-500 rounded-xl w-80 lg:w-72 flex-shrink-0 h-screen/2 flex flex-col items-center justify-center">
          <lottie-player src="https://lottie.host/1dd389ee-6015-42ee-accb-e036bb954032/Elw6rum7um.json" background="##FFFFFF" speed="1" style="max-width: 300px; height: 200px" loop autoplay direction="1" mode="normal"></lottie-player>
        ...
        <div class="snap-start p-8 bg-gradient-to-r shadow-md from-cyan-300 to-blue-300 dark:from-indigo-500 dark:to-violet-500 rounded-xl w-80 lg:w-72 flex-shrink-0 h-screen/2 flex flex-col items-center justify-center">
          <lottie-player src="https://lottie.host/ed6d53ef-df0b-49fd-b24c-a5982fb44071/VpJIaDOqar.json" background="##ffffff" speed="1" style="max-width: 300px; height: 200px" loop autoplay direction="1" mode="normal"></lottie-player>
          <p class="text-xl tracking-wide text-center font-semibold dark:text-slate-950">
      ...
      <div class="px-8 py-12 max-w-screen-xl mx-auto">
        <div class="flex flex-col md:pb-10">
          ...
          <div class="flex flex-col md:flex-row-reverse md:gap-10 md:items-center md:justify-center">
            <div>
              <lottie-player src="https://lottie.host/c78cfe5e-62dc-4460-8f4a-3d3e0936a2ff/nfJjW5sWCc.json" background="##FFFFFF" speed="1" style="max-width: 300px; height: 300px" loop autoplay direction="1" mode="normal"></lottie-player>
            </div>
          ...
          <div class="flex flex-col md:flex-row md:gap-10 md:items-center md:justify-center">
            <div>
              <lottie-player src="https://lottie.host/4ebd32d4-1447-4f7a-b882-86f1dd323e25/9A3Jxrk5a4.json" background="##FFFFFF" speed="1" style="max-width: 300px; height: 300px" loop autoplay direction="1" mode="normal"></lottie-player>
            </div>
            <div class="flex flex-col md:w-1/2">
